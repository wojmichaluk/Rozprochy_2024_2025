...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			// test na potrzeby punktu 2.2.9
			// ObjectPrx base1 = communicator.stringToProxy("calc/calc44:tcp -h 127.0.0.2 -p 10000 -z : udp -h 127.0.0.2 -p 10000 -z");

			// na potrzeby punktów 2.2.10 i 2.2.11
				...
				try {
					...
					switch (line) {
						...
						case "subtract":
							...
							System.out.println("RESULT = " + r);
							break;
						case "avg": // dodane na potrzeby 2.2.14
							try {
								long[] arr1 = { 1, 2, 3, 4 };
								long[] arr2 = {};

								float res = obj1.avg(arr1);
